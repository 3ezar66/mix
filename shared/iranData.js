...
export function getProvinceIpRanges(provinceName) {
...
export function getCityIpRanges(cityName) {
...
export function calculateScanRange(ipRanges) {
...
export function getISPByASN(asn) {
    return iranASNs[asn] || `ASN ${asn}`;
}
