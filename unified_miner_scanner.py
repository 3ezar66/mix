...
# --- دریافت اطلاعات منطقه و رنج IP ---
def get_location_info():
    print("✅ سیستم کشف ماینر غیرمجاز - نسخه یکپارچه\n")
    ...
    return str(net[0]), str(net[-1]), province, city
...
def generate_html_report():
    ...
    with open("report.html", "w", encoding="utf-8") as f:
        ...
        f.write("<h1>گزارش اسکن IP ماینر - نسخه یکپارچه</h1><table border=1><tr><th>IP</th><th>ProxyCheck</th><th>AbuseIPDB</th><th>Shodan</th><th>IPInfo</th><th>Open Ports</th><th>Timestamp</th></tr>")
        for row in rows:
            f.write("<tr>")
            for col in row:
...
# --- اجرای اسکن ---
def main():
    start_ip, end_ip, province, city = get_location_info()
