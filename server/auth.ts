...
export function setupAuth(app: express.Application) {
  ...
  passport.use(
    new LocalStrategy(async (username: string, password: string, done: (error: any, user?: any) => void) => {
      try {
  ...
  app.post("/api/register", async (req: Request & {body: {username: string; password: string}}, res: Response, next: NextFunction) => {
    try {
